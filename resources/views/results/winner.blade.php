                    ...
                    <center>
                        <div class="panel-body">
                            <div class="card" style="width:200px;">
                                <img class="card-img-top" src="{{url('images/'.$user->image)}}" alt="Card image"
                                     style="width:50%">
                                <div class="card-body">
                                    ...
                                    <img class="card-img-bottom" src="{{url('images/'.$user->party->symbol)}}"
                                         alt="Card image" style="width:100px; height: 50px"><br>
                                    <b><u>Result</u></b><br>
            ...
            <div class="panel-body">
                ...
                <center>
                    <div class="card" style="width:200px; margin-top: -133px">
                        ...
                        <div class="card-body">
                            <h5 class="card-title"><b>Total Male Voters : {{count($voters->where('gender','male'))}}</b>
                            </h5>
                        </div>
                    </div>
                </center>
                ...
                <div class="card" style="width:200px; margin-top: -133px;float: right">
                    ...
                    <div class="card-body">
                        <h5 class="card-title"><b>Total Female Voters : {{count($voters->where('gender','female'))}}</b>
                        </h5>
                    </div>
                </div>
            </div>
